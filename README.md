...
- **[EmblemCompany/Agent-skills](https://github.com/EmblemCompany/Agent-skills/tree/main/skills/emblem-ai-agent-wallet)** - Crypto wallet management across 7 blockchains via EmblemAI
